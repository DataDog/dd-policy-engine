...
#define dd_wls_BoolOperation_BOOL_UNKNOWN ((dd_wls_BoolOperation_enum_t)INT8_C(0))
#define dd_wls_BoolOperation_BOOL_AND ((dd_wls_BoolOperation_enum_t)INT8_C(1))
#define dd_wls_BoolOperation_BOOL_NOT ((dd_wls_BoolOperation_enum_t)INT8_C(2))
#define dd_wls_BoolOperation_BOOL_OR ((dd_wls_BoolOperation_enum_t)INT8_C(3))
#define dd_wls_BoolOperation_BOOL_COUNT ((dd_wls_BoolOperation_enum_t)INT8_C(4))

static inline const char *dd_wls_BoolOperation_name(dd_wls_BoolOperation_enum_t value)
{
    switch (value) {
    case dd_wls_BoolOperation_BOOL_UNKNOWN: return "BOOL_UNKNOWN";
...
{
    switch (value) {
    case dd_wls_BoolOperation_BOOL_UNKNOWN: return 1;
