...
#define __flatbuffers_read_vt(ID, offset, t)                                                                           \
  ...
  {                                                                                                                    \
    ...
    id__tmp = ID;                                                                                                      \
    vt__tmp = (flatbuffers_voffset_t *)((uint8_t *)(t) - __flatbuffers_soffset_read_from_pe(t));                       \
...
#define __flatbuffers_define_scalar_field(ID, N, NK, TK, T, V)                                                         \
  ...
  static inline const T *N##_##NK##_get_ptr(N##_table_t t__tmp)                                                        \
      __flatbuffers_scalar_field(T, ID, t__tmp) static inline int N##_##NK##_is_present(N##_table_t t__tmp)            \
          __flatbuffers_field_present(ID, t__tmp) __flatbuffers_define_scan_by_scalar_field(N, NK, T)
#define __flatbuffers_define_scalar_optional_field(ID, N, NK, TK, T, V)                                                \
  __flatbuffers_define_scalar_field(                                                                                   \
    ...
    ret.value = offset__tmp ? __flatbuffers_read_scalar_at_byteoffset(TK, t__tmp, offset__tmp) : V;                    \
    return ret;                                                                                                        \
  }
...
#define __flatbuffers_define_struct_field(ID, N, NK, T, r)                                                             \
  static inline T N##_##NK##_get(N##_table_t t__tmp)                                                                   \
      __flatbuffers_struct_field(T, ID, t__tmp, r) static inline T N##_##NK(N##_table_t t__tmp)                        \
          __flatbuffers_struct_field(T, ID, t__tmp, r) static inline int N##_##NK##_is_present(N##_table_t t__tmp)     \
              __flatbuffers_field_present(ID, t__tmp)
#define __flatbuffers_define_vector_field(ID, N, NK, T, r)                                                             \
  static inline T N##_##NK##_get(N##_table_t t__tmp)                                                                   \
      __flatbuffers_vector_field(T, ID, t__tmp, r) static inline T N##_##NK(N##_table_t t__tmp)                        \
          __flatbuffers_vector_field(T, ID, t__tmp, r) static inline int N##_##NK##_is_present(N##_table_t t__tmp)     \
              __flatbuffers_field_present(ID, t__tmp)
#define __flatbuffers_define_table_field(ID, N, NK, T, r)                                                              \
  static inline T N##_##NK##_get(N##_table_t t__tmp)                                                                   \
      __flatbuffers_table_field(T, ID, t__tmp, r) static inline T N##_##NK(N##_table_t t__tmp)                         \
          __flatbuffers_table_field(T, ID, t__tmp, r) static inline int N##_##NK##_is_present(N##_table_t t__tmp)      \
              __flatbuffers_field_present(ID, t__tmp)
#define __flatbuffers_define_string_field(ID, N, NK, r)                                                                \
  static inline flatbuffers_string_t N##_##NK##_get(N##_table_t t__tmp) __flatbuffers_vector_field(                    \
      flatbuffers_string_t, ID, t__tmp, r                                                                              \
  ) static inline flatbuffers_string_t N##_##NK(N##_table_t t__tmp)                                                    \
      __flatbuffers_vector_field(flatbuffers_string_t, ID, t__tmp, r) static inline int N##_##NK##_is_present(         \
          N##_table_t t__tmp                                                                                           \
      ) __flatbuffers_field_present(ID, t__tmp) __flatbuffers_define_scan_by_string_field(N, NK)
...
#define __flatbuffers_define_scalar_vec_at(N, T)                                                                       \
  static inline T N##_vec_at(N##_vec_t vec__tmp, size_t i__tmp) __flatbuffers_scalar_vec_at(N, vec__tmp, i__tmp)
    typedef const char *flatbuffers_string_t;
static inline size_t flatbuffers_string_len(flatbuffers_string_t s)
    __flatbuffers_string_len(s) typedef const flatbuffers_uoffset_t *flatbuffers_string_vec_t;
typedef flatbuffers_uoffset_t *flatbuffers_string_mutable_vec_t;
static inline size_t flatbuffers_string_vec_len(flatbuffers_string_vec_t vec) __flatbuffers_vec_len(vec
) static inline flatbuffers_string_t flatbuffers_string_vec_at(flatbuffers_string_vec_t vec, size_t i)
    __flatbuffers_offset_vec_at(flatbuffers_string_t, vec, i, sizeof(vec[0])) typedef const void *flatbuffers_generic_t;
...
static inline size_t flatbuffers_generic_vec_len(flatbuffers_generic_vec_t vec)
    ...
    flatbuffers_generic_vec_at(flatbuffers_generic_vec_t vec, size_t i)
        __flatbuffers_offset_vec_at(flatbuffers_generic_t, vec, i, 0) static inline flatbuffers_generic_t
    flatbuffers_generic_vec_at_as_string(flatbuffers_generic_vec_t vec, size_t i)
        __flatbuffers_offset_vec_at(flatbuffers_generic_t, vec, i, sizeof(vec[0])) typedef struct flatbuffers_union {
...
static inline flatbuffers_mutable_union_vec_t flatbuffers_mutable_union_vec_cast(flatbuffers_union_vec_t uv__tmp) {
  flatbuffers_mutable_union_vec_t muv = {
      (flatbuffers_union_type_t *)uv__tmp.type, (flatbuffers_uoffset_t *)uv__tmp.value
  };
  return muv;
}
#define __flatbuffers_union_type_field(ID, t)                                                                          \
  {                                                                                                                    \
    __flatbuffers_read_vt(ID, offset__tmp, t) return offset__tmp                                                       \
        ? __flatbuffers_read_scalar_at_byteoffset(__flatbuffers_utype, t, offset__tmp)                                 \
        : 0;                                                                                                           \
  }
...
#define __flatbuffers_define_union_field(NS, ID, N, NK, T, r)                                                          \
  ...
  ) __##NS##union_type_field(((ID) - 1), t__tmp) static inline NS##generic_t N##_##NK##_get(N##_table_t t__tmp)        \
      __##NS##table_field(NS##generic_t, ID, t__tmp, r) static inline T##_union_type_t N##_##NK##_type(                \
          N##_table_t t__tmp                                                                                           \
      ) __##NS##union_type_field(((ID) - 1), t__tmp) static inline NS##generic_t N##_##NK(N##_table_t t__tmp           \
      ) __##NS##table_field(NS##generic_t, ID, t__tmp, r) static inline int N##_##NK##_is_present(N##_table_t t__tmp)  \
          __##NS##field_present(ID, t__tmp) static inline T##_union_t N##_##NK##_union(N##_table_t t__tmp) {           \
...
#define __flatbuffers_define_union_vector_field(NS, ID, N, NK, T, r)                                                   \
  __##NS##define_vector_field(ID - 1, N, NK##_type, T##_vec_t, r) __##NS##define_vector_field(                         \
      ID, N, NK, flatbuffers_generic_vec_t, r                                                                          \
    ...
    FLATCC_ASSERT(NS##vec_len(uv__tmp.type) == NS##vec_len(uv__tmp.value) && "union vector type length mismatch");     \
    return uv__tmp;                                                                                                    \
  }
#include <string.h>
...
static inline int __flatbuffers_string_cmp(flatbuffers_string_t v, const char *s, size_t n) {
  (void)n;
  return strcmp(v, s);
}
...
#define __flatbuffers_define_find_by_string_field(N, NK)                                                               \
  ...
  static inline size_t N##_vec_find_by_##NK(N##_vec_t vec__tmp, const char *s__tmp)                                    \
      __flatbuffers_find_by_string_field(                                                                              \
          N##_##NK, vec__tmp, N##_vec_at, N##_vec_len, s__tmp                                                          \
...
#define __flatbuffers_define_scan_by_scalar_field(N, NK, T)                                                            \
  static inline size_t N##_vec_scan_by_##NK(N##_vec_t vec__tmp, T key__tmp) __flatbuffers_scan_by_scalar_field(        \
      0, N##_vec_len(vec__tmp), N##_##NK##_get, vec__tmp, N##_vec_at, N##_vec_len, key__tmp, T                         \
      ...
      __flatbuffers_scan_by_scalar_field(                                                                              \
          begin__tmp, __flatbuffers_min(end__tmp, N##_vec_len(vec__tmp)), N##_##NK##_get, vec__tmp, N##_vec_at,        \
          ...
          __flatbuffers_rscan_by_scalar_field(                                                                         \
              ...
              N##_vec_rscan_ex_by_##NK(N##_vec_t vec__tmp, size_t begin__tmp, size_t end__tmp, T key__tmp)             \
                  __flatbuffers_rscan_by_scalar_field(                                                                 \
                      begin__tmp, __flatbuffers_min(end__tmp, N##_vec_len(vec__tmp)), N##_##NK##_get, vec__tmp,        \
                      N##_vec_at, N##_vec_len, key__tmp, T                                                             \
                  )
#define __flatbuffers_define_scalar_scan(N, T)                                                                         \
  static inline size_t N##_vec_scan(N##_vec_t vec__tmp, T key__tmp) __flatbuffers_scan_by_scalar_field(                \
      0, N##_vec_len(vec__tmp), __flatbuffers_identity, vec__tmp, N##_vec_at, N##_vec_len, key__tmp, T                 \
  ) static inline size_t N##_vec_scan_ex(N##_vec_t vec__tmp, size_t begin__tmp, size_t end__tmp, T key__tmp)           \
      __flatbuffers_scan_by_scalar_field(                                                                              \
          begin__tmp, __flatbuffers_min(end__tmp, N##_vec_len(vec__tmp)), __flatbuffers_identity, vec__tmp,            \
          N##_vec_at, N##_vec_len, key__tmp, T                                                                         \
...
#define __flatbuffers_define_scan_by_string_field(N, NK)                                                               \
  static inline size_t N##_vec_scan_by_##NK(N##_vec_t vec__tmp, const char *s__tmp)                                    \
      __flatbuffers_scan_by_string_field(                                                                              \
          0, N##_vec_len(vec__tmp), N##_##NK##_get, vec__tmp, N##_vec_at, N##_vec_len, s__tmp                          \
          ...
          __flatbuffers_scan_by_string_n_field(                                                                        \
              0, N##_vec_len(vec__tmp), N##_##NK##_get, vec__tmp, N##_vec_at, N##_vec_len, s__tmp, n__tmp              \
          ) static inline size_t                                                                                       \
              N##_vec_scan_ex_by_##NK(N##_vec_t vec__tmp, size_t begin__tmp, size_t end__tmp, const char *s__tmp)      \
                  __flatbuffers_scan_by_string_field(                                                                  \
                      begin__tmp, __flatbuffers_min(end__tmp, N##_vec_len(vec__tmp)), N##_##NK##_get, vec__tmp,        \
                      N##_vec_at, N##_vec_len, s__tmp                                                                  \
                  ) static inline size_t                                                                               \
                      N##_vec_scan_ex_n_by_##NK(                                                                       \
                          N##_vec_t vec__tmp, size_t begin__tmp, size_t end__tmp, const char *s__tmp, size_t n__tmp    \
                      )                                                                                                \
                          __flatbuffers_scan_by_string_n_field(                                                        \
                              begin__tmp, __flatbuffers_min(end__tmp, N##_vec_len(vec__tmp)), N##_##NK##_get,          \
                              vec__tmp, N##_vec_at, N##_vec_len, s__tmp, n__tmp                                        \
                          ) static inline size_t N##_vec_rscan_by_##NK(N##_vec_t vec__tmp, const char *s__tmp)         \
                              __flatbuffers_rscan_by_string_field(                                                     \
                                  0, N##_vec_len(vec__tmp), N##_##NK##_get, vec__tmp, N##_vec_at, N##_vec_len, s__tmp  \
                              ) static inline size_t                                                                   \
                                  N##_vec_rscan_n_by_##NK(N##_vec_t vec__tmp, const char *s__tmp, size_t n__tmp)       \
                                      __flatbuffers_rscan_by_string_n_field(                                           \
                                          0, N##_vec_len(vec__tmp), N##_##NK##_get, vec__tmp, N##_vec_at, N##_vec_len, \
                                          s__tmp, n__tmp                                                               \
                                      ) static inline size_t                                                           \
                                          N##_vec_rscan_ex_by_##NK(                                                    \
                                              ...
                                              __flatbuffers_rscan_by_string_field(                                     \
                                                  begin__tmp, __flatbuffers_min(end__tmp, N##_vec_len(vec__tmp)),      \
                                                  N##_##NK##_get, vec__tmp, N##_vec_at, N##_vec_len, s__tmp            \
                                              ) static inline size_t                                                   \
...
#define __flatbuffers_heap_sort(N, X, A, E, L, TK, TE, D, S)                                                           \
  static inline void __##N##X##__heap_sift_down(N##_mutable_vec_t vec__tmp, size_t start__tmp, size_t end__tmp) {      \
...
#define __flatbuffers_define_sort_by_field(N, NK, TK, TE, D, S)                                                        \
  __flatbuffers_heap_sort(                                                                                             \
      N, _sort_by_##NK, N##_##NK##_get, N##_vec_at, N##_vec_len, TK, TE, D, S                                          \
...
#define __flatbuffers_define_sort(N, TK, TE, D, S)                                                                     \
  __flatbuffers_heap_sort(                                                                                             \
      N, , __flatbuffers_identity, N##_vec_at, N##_vec_len, TK, TE, D, S                                               \
  ) static inline void N##_vec_sort(N##_mutable_vec_t vec__tmp) {                                                      \
...
#define __flatbuffers_define_table_sort_by_scalar_field(N, NK, TK)                                                     \
  __flatbuffers_define_sort_by_field(                                                                                  \
      N, NK, TK, flatbuffers_uoffset_t, __flatbuffers_scalar_diff, __flatbuffers_table_swap                            \
  )
#define __flatbuffers_define_table_sort_by_string_field(N, NK)                                                         \
  __flatbuffers_define_sort_by_field(                                                                                  \
      N, NK, flatbuffers_string_t, flatbuffers_uoffset_t, __flatbuffers_string_diff, __flatbuffers_table_swap          \
  )
#define __flatbuffers_define_scalar_sort(N, T)                                                                         \
  __flatbuffers_define_sort(N, T, T, __flatbuffers_scalar_diff, __flatbuffers_scalar_swap)
#define __flatbuffers_define_string_sort()                                                                             \
  __flatbuffers_define_sort(                                                                                           \
      flatbuffers_string, flatbuffers_string_t, flatbuffers_uoffset_t, __flatbuffers_string_diff,                      \
...
#define __flatbuffers_define_scalar_vector(N, T)                                                                       \
  ...
  __flatbuffers_define_scalar_vec_len(N) __flatbuffers_define_scalar_vec_at(N, T)                                      \
      __flatbuffers_define_scalar_find(N, T) __flatbuffers_define_scalar_scan(N, T)                                    \
          __flatbuffers_define_scalar_sort(N, T)

#define __flatbuffers_define_integer_type(N, T, W)                                                                     \
  __flatcc_define_integer_accessors(N, T, W, flatbuffers_endian) __flatbuffers_define_scalar_vector(N, T)
__flatbuffers_define_scalar_vector(flatbuffers_bool, flatbuffers_bool_t)
    ...
    flatbuffers_string_vec_find(flatbuffers_string_vec_t vec, const char *s) __flatbuffers_find_by_string_field(
    ...
    flatbuffers_string_vec_scan_ex(flatbuffers_string_vec_t vec, size_t begin, size_t end, const char *s)
        __flatbuffers_scan_by_string_field(
            begin,
    ...
    flatbuffers_string_vec_scan_ex_n(flatbuffers_string_vec_t vec, size_t begin, size_t end, const char *s, size_t n)
        __flatbuffers_scan_by_string_n_field(
            begin,
            __flatbuffers_min(end, flatbuffers_string_vec_len(vec)),
            __flatbuffers_identity,
    ...
    flatbuffers_string_vec_rscan_ex(flatbuffers_string_vec_t vec, size_t begin, size_t end, const char *s)
        __flatbuffers_rscan_by_string_field(
            begin,
            __flatbuffers_min(end, flatbuffers_string_vec_len(vec)),
            __flatbuffers_identity,
    ...
    flatbuffers_string_vec_rscan_ex_n(flatbuffers_string_vec_t vec, size_t begin, size_t end, const char *s, size_t n)
        __flatbuffers_rscan_by_string_n_field(
            begin,
            __flatbuffers_min(end, flatbuffers_string_vec_len(vec)),
            __flatbuffers_identity,
...
#define __flatbuffers_read_root(T, K, buffer, fid)                                                                     \
  ((!buffer || !flatbuffers_has_identifier(buffer, fid))                                                               \
       ? 0                                                                                                             \
       : ((T##_##K##t)(((uint8_t *)buffer) + __flatbuffers_uoffset_read_from_pe(buffer))))
