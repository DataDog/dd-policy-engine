...
#define dd_wls_StringEvaluators_STRING_EVAL_UNKNOWN ((dd_wls_StringEvaluators_enum_t)INT8_C(0))
#define dd_wls_StringEvaluators_COMPONENT ((dd_wls_StringEvaluators_enum_t)INT8_C(1))
#define dd_wls_StringEvaluators_PROCESS_EXE ((dd_wls_StringEvaluators_enum_t)INT8_C(2))
#define dd_wls_StringEvaluators_PROCESS_EXE_FULL_PATH ((dd_wls_StringEvaluators_enum_t)INT8_C(3))
#define dd_wls_StringEvaluators_PROCESS_BASEDIR_PATH ((dd_wls_StringEvaluators_enum_t)INT8_C(4))
#define dd_wls_StringEvaluators_PROCESS_ARGV ((dd_wls_StringEvaluators_enum_t)INT8_C(5))
#define dd_wls_StringEvaluators_PROCESS_CWD ((dd_wls_StringEvaluators_enum_t)INT8_C(6))
#define dd_wls_StringEvaluators_RUNTIME_LANGUAGE ((dd_wls_StringEvaluators_enum_t)INT8_C(7))
#define dd_wls_StringEvaluators_RUNTIME_ENTRY_POINT_FILE ((dd_wls_StringEvaluators_enum_t)INT8_C(8))
#define dd_wls_StringEvaluators_RUNTIME_ENTRY_POINT_JAR ((dd_wls_StringEvaluators_enum_t)INT8_C(9))
#define dd_wls_StringEvaluators_RUNTIME_ENTRY_POINT_CLASS ((dd_wls_StringEvaluators_enum_t)INT8_C(10))
#define dd_wls_StringEvaluators_RUNTIME_ENTRY_POINT_PACKAGE ((dd_wls_StringEvaluators_enum_t)INT8_C(11))
#define dd_wls_StringEvaluators_RUNTIME_ENTRY_POINT_MODULE ((dd_wls_StringEvaluators_enum_t)INT8_C(12))
#define dd_wls_StringEvaluators_RUNTIME_ENTRY_POINT_SOURCE ((dd_wls_StringEvaluators_enum_t)INT8_C(13))
#define dd_wls_StringEvaluators_RUNTIME_DOPTION ((dd_wls_StringEvaluators_enum_t)INT8_C(14))
#define dd_wls_StringEvaluators_RUNTIME_VERSION ((dd_wls_StringEvaluators_enum_t)INT8_C(15))
#define dd_wls_StringEvaluators_LIBC_FLAVOR ((dd_wls_StringEvaluators_enum_t)INT8_C(16))
#define dd_wls_StringEvaluators_LIBC_VERSION ((dd_wls_StringEvaluators_enum_t)INT8_C(17))
#define dd_wls_StringEvaluators_MACHINE_ARCHITECTURE ((dd_wls_StringEvaluators_enum_t)INT8_C(18))
#define dd_wls_StringEvaluators_HOST_NAME ((dd_wls_StringEvaluators_enum_t)INT8_C(19))
#define dd_wls_StringEvaluators_HOST_IP ((dd_wls_StringEvaluators_enum_t)INT8_C(20))
#define dd_wls_StringEvaluators_OS ((dd_wls_StringEvaluators_enum_t)INT8_C(21))
#define dd_wls_StringEvaluators_OS_DISTRO ((dd_wls_StringEvaluators_enum_t)INT8_C(22))
#define dd_wls_StringEvaluators_OS_DISTRO_VERSION ((dd_wls_StringEvaluators_enum_t)INT8_C(23))
#define dd_wls_StringEvaluators_OS_DISTRO_CODENAME ((dd_wls_StringEvaluators_enum_t)INT8_C(24))
#define dd_wls_StringEvaluators_OS_KERNEL_VERSION ((dd_wls_StringEvaluators_enum_t)INT8_C(25))
#define dd_wls_StringEvaluators_OS_KERNEL_NAME ((dd_wls_StringEvaluators_enum_t)INT8_C(26))
#define dd_wls_StringEvaluators_OS_USER ((dd_wls_StringEvaluators_enum_t)INT8_C(27))
#define dd_wls_StringEvaluators_OS_USER_GROUP ((dd_wls_StringEvaluators_enum_t)INT8_C(28))
#define dd_wls_StringEvaluators_CONTAINER_IMAGE ((dd_wls_StringEvaluators_enum_t)INT8_C(29))
#define dd_wls_StringEvaluators_CONTAINER_ID ((dd_wls_StringEvaluators_enum_t)INT8_C(30))
...
{
    switch (value) {
    case dd_wls_StringEvaluators_STRING_EVAL_UNKNOWN: return "STRING_EVAL_UNKNOWN";
...
{
    switch (value) {
    case dd_wls_StringEvaluators_STRING_EVAL_UNKNOWN: return 1;
...
/**  An enum representing the type of action to take. */
#define dd_wls_NumericEvaluators_NUMERIC_EVAL_UNKNOWN ((dd_wls_NumericEvaluators_enum_t)INT8_C(0))
#define dd_wls_NumericEvaluators_JAVA_HEAP ((dd_wls_NumericEvaluators_enum_t)INT8_C(1))
#define dd_wls_NumericEvaluators_RUNTIME_VERSION_MAJOR ((dd_wls_NumericEvaluators_enum_t)INT8_C(2))
#define dd_wls_NumericEvaluators_RUNTIME_VERSION_MINOR ((dd_wls_NumericEvaluators_enum_t)INT8_C(3))
#define dd_wls_NumericEvaluators_RUNTIME_VERSION_PATCH ((dd_wls_NumericEvaluators_enum_t)INT8_C(4))
#define dd_wls_NumericEvaluators_OS_DISTRO_VERSION_MAJOR ((dd_wls_NumericEvaluators_enum_t)INT8_C(5))
#define dd_wls_NumericEvaluators_OS_DISTRO_VERSION_MINOR ((dd_wls_NumericEvaluators_enum_t)INT8_C(6))
#define dd_wls_NumericEvaluators_OS_DISTRO_VERSION_PATCH ((dd_wls_NumericEvaluators_enum_t)INT8_C(7))
#define dd_wls_NumericEvaluators_OS_KERNEL_VERSION_MAJOR ((dd_wls_NumericEvaluators_enum_t)INT8_C(8))
#define dd_wls_NumericEvaluators_OS_KERNEL_VERSION_MINOR ((dd_wls_NumericEvaluators_enum_t)INT8_C(9))
#define dd_wls_NumericEvaluators_OS_KERNEL_VERSION_PATCH ((dd_wls_NumericEvaluators_enum_t)INT8_C(10))
#define dd_wls_NumericEvaluators_LIBC_VERSION_MAJOR ((dd_wls_NumericEvaluators_enum_t)INT8_C(11))
#define dd_wls_NumericEvaluators_LIBC_VERSION_MINOR ((dd_wls_NumericEvaluators_enum_t)INT8_C(12))
#define dd_wls_NumericEvaluators_LIBC_VERSION_PATCH ((dd_wls_NumericEvaluators_enum_t)INT8_C(13))
#define dd_wls_NumericEvaluators_NUM_EVAL_COUNT ((dd_wls_NumericEvaluators_enum_t)INT8_C(14))

static inline const char *dd_wls_NumericEvaluators_name(dd_wls_NumericEvaluators_enum_t value)
{
    switch (value) {
    case dd_wls_NumericEvaluators_NUMERIC_EVAL_UNKNOWN: return "NUMERIC_EVAL_UNKNOWN";
...
{
    switch (value) {
    case dd_wls_NumericEvaluators_NUMERIC_EVAL_UNKNOWN: return 1;
