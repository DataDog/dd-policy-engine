...
#define __dd_wls_Policy_formal_args                                                                                    \
  , flatbuffers_string_ref_t v0, dd_wls_NodeTypeWrapper_ref_t v1, dd_wls_Action_vec_ref_t v2
...
__flatbuffers_build_table_prolog(
    flatbuffers_,
    dd_wls_Policy,
    dd_wls_Policy_file_identifier,
    dd_wls_Policy_type_identifier
)
...
__flatbuffers_build_table_prolog(
    flatbuffers_,
    dd_wls_Policies,
    dd_wls_Policies_file_identifier,
    dd_wls_Policies_type_identifier
)
    ...
    __flatbuffers_build_string_field(0, flatbuffers_, dd_wls_Policy_description, dd_wls_Policy)
        __flatbuffers_build_table_field(1, flatbuffers_, dd_wls_Policy_rules, dd_wls_NodeTypeWrapper, dd_wls_Policy)
            __flatbuffers_build_table_vector_field(2, flatbuffers_, dd_wls_Policy_actions, dd_wls_Action, dd_wls_Policy)
                ...
                static inline dd_wls_Policy_ref_t
    dd_wls_Policy_create(flatbuffers_builder_t *B __dd_wls_Policy_formal_args) {
  if (dd_wls_Policy_start(B) || dd_wls_Policy_description_add(B, v0) || dd_wls_Policy_rules_add(B, v1) ||
...
static dd_wls_Policy_ref_t dd_wls_Policy_clone(flatbuffers_builder_t *B, dd_wls_Policy_table_t t) {
  ...
  if (dd_wls_Policy_start(B) || dd_wls_Policy_description_pick(B, t) || dd_wls_Policy_rules_pick(B, t) ||
...
__flatbuffers_build_table_vector_field(0, flatbuffers_, dd_wls_Policies_policies, dd_wls_Policy, dd_wls_Policies)
    ...
    static inline dd_wls_Policies_ref_t dd_wls_Policies_create(flatbuffers_builder_t *B __dd_wls_Policies_formal_args) {
  if (dd_wls_Policies_start(B) || dd_wls_Policies_policies_add(B, v0)) {
    return 0;
  }
...
static dd_wls_Policies_ref_t dd_wls_Policies_clone(flatbuffers_builder_t *B, dd_wls_Policies_table_t t) {
  __flatbuffers_memoize_begin(B, t);
  if (dd_wls_Policies_start(B) || dd_wls_Policies_policies_pick(B, t)) {
    return 0;
  }
