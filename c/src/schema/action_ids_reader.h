...
#define dd_wls_ActionId_ACTION_UNKNOWN ((dd_wls_ActionId_enum_t)INT8_C(0))
#define dd_wls_ActionId_INJECT_DENY ((dd_wls_ActionId_enum_t)INT8_C(1))
#define dd_wls_ActionId_INJECT_ALLOW ((dd_wls_ActionId_enum_t)INT8_C(2))
#define dd_wls_ActionId_ENABLE_SDK ((dd_wls_ActionId_enum_t)INT8_C(3))
#define dd_wls_ActionId_ENABLE_PROFILER ((dd_wls_ActionId_enum_t)INT8_C(4))
#define dd_wls_ActionId_SET_ENVAR ((dd_wls_ActionId_enum_t)INT8_C(5))
#define dd_wls_ActionId_REEXEC ((dd_wls_ActionId_enum_t)INT8_C(6))
#define dd_wls_ActionId_ACTIONS_COUNT ((dd_wls_ActionId_enum_t)INT8_C(7))

static inline const char *dd_wls_ActionId_name(dd_wls_ActionId_enum_t value)
{
    switch (value) {
    case dd_wls_ActionId_ACTION_UNKNOWN: return "ACTION_UNKNOWN";
...
{
    switch (value) {
    case dd_wls_ActionId_ACTION_UNKNOWN: return 1;
