...
#define __dd_wls_Action_formal_args                                                                                    \
  , dd_wls_ActionId_enum_t v0, flatbuffers_string_ref_t v1, flatbuffers_string_vec_ref_t v2
...
__flatbuffers_build_table_prolog(
    flatbuffers_,
    dd_wls_Action,
    dd_wls_Action_file_identifier,
    dd_wls_Action_type_identifier
)

    __flatbuffers_build_scalar_field(
        0,
        flatbuffers_,
        dd_wls_Action_action,
        dd_wls_ActionId,
        dd_wls_ActionId_enum_t,
        1,
        1,
        INT8_C(0),
        dd_wls_Action
        ...
        __flatbuffers_build_string_vector_field(2, flatbuffers_, dd_wls_Action_values, dd_wls_Action)
            ...
            static inline dd_wls_Action_ref_t
    dd_wls_Action_create(flatbuffers_builder_t *B __dd_wls_Action_formal_args) {
  if (dd_wls_Action_start(B) || dd_wls_Action_description_add(B, v1) || dd_wls_Action_values_add(B, v2) ||
...
static dd_wls_Action_ref_t dd_wls_Action_clone(flatbuffers_builder_t *B, dd_wls_Action_table_t t) {
  ...
  if (dd_wls_Action_start(B) || dd_wls_Action_description_pick(B, t) || dd_wls_Action_values_pick(B, t) ||
