...
#define __flatbuffers_build_table_prolog(NS, N, FID, TFID)                                                             \
  __flatbuffers_build_table_vector_ops(NS, N##_vec, N) __flatbuffers_build_table_root(NS, N, FID, TFID)
...
#define __flatbuffers_build_struct_root(NS, N, A, FID, TFID)                                                           \
  ...
  static inline NS##buffer_ref_t N##_create_as_root(NS##builder_t *B __##N##_formal_args) {                            \
    return flatcc_builder_create_buffer(B, FID, 0, N##_create(B __##N##_call_args), A, 0);                             \
  }                                                                                                                    \
  static inline NS##buffer_ref_t N##_create_as_root_with_size(NS##builder_t *B __##N##_formal_args) {                  \
    return flatcc_builder_create_buffer(B, FID, 0, N##_create(B __##N##_call_args), A, flatcc_builder_with_size);      \
  }                                                                                                                    \
  static inline NS##buffer_ref_t N##_create_as_typed_root(NS##builder_t *B __##N##_formal_args) {                      \
    return flatcc_builder_create_buffer(B, TFID, 0, N##_create(B __##N##_call_args), A, 0);                            \
  }                                                                                                                    \
  static inline NS##buffer_ref_t N##_create_as_typed_root_with_size(NS##builder_t *B __##N##_formal_args) {            \
    return flatcc_builder_create_buffer(B, TFID, 0, N##_create(B __##N##_call_args), A, flatcc_builder_with_size);     \
  }                                                                                                                    \
...
#define __flatbuffers_build_nested_table_root(NS, N, TN, FID, TFID)                                                    \
  ...
  static inline int N##_nest(NS##builder_t *B, void *data, size_t size, uint16_t align) {                              \
    return N##_add(B, flatcc_builder_create_vector(B, data, size, 1, align ? align : 8, FLATBUFFERS_COUNT_MAX(1)));    \
  }                                                                                                                    \
...
#define __flatbuffers_build_nested_struct_root(NS, N, TN, A, FID, TFID)                                                \
  ...
  static inline int N##_create_as_root(NS##builder_t *B __##TN##_formal_args) {                                        \
    return N##_add(                                                                                                    \
        B, flatcc_builder_create_buffer(B, FID, 0, TN##_create(B __##TN##_call_args), A, flatcc_builder_is_nested)     \
    );                                                                                                                 \
  }                                                                                                                    \
  static inline int N##_create_as_typed_root(NS##builder_t *B __##TN##_formal_args) {                                  \
    return N##_add(                                                                                                    \
        B, flatcc_builder_create_buffer(B, TFID, 0, TN##_create(B __##TN##_call_args), A, flatcc_builder_is_nested)    \
    );                                                                                                                 \
  }                                                                                                                    \
  static inline int N##_nest(NS##builder_t *B, void *data, size_t size, uint16_t align) {                              \
    return N##_add(                                                                                                    \
        B, flatcc_builder_create_vector(B, data, size, 1, align < A ? A : align, FLATBUFFERS_COUNT_MAX(1))             \
    );                                                                                                                 \
  }                                                                                                                    \
  static inline int N##_typed_nest(NS##builder_t *B, void *data, size_t size, uint16_t align) {                        \
    return N##_add(                                                                                                    \
...
#define __flatbuffers_build_vector_ops(NS, V, N, TN, T)                                                                \
  ...
  static inline T *V##_push(NS##builder_t *B, const T *p) {                                                            \
    T *_p;                                                                                                             \
    return (_p = (T *)flatcc_builder_extend_vector(B, 1)) ? (memcpy(_p, p, TN##__size()), _p) : 0;                     \
  }                                                                                                                    \
  ...
  static inline T *V##_push_create(NS##builder_t *B __##TN##_formal_args) {                                            \
    T *_p;                                                                                                             \
    return (_p = (T *)flatcc_builder_extend_vector(B, 1)) ? TN##_assign(_p __##TN##_call_args) : 0;                    \
  }
...
#define __flatbuffers_build_vector(NS, N, T, S, A)                                                                     \
  ...
  static inline N##_vec_ref_t N##_vec_clone(NS##builder_t *B, N##_vec_t vec) {                                         \
    __flatbuffers_memoize(                                                                                             \
        B, vec, flatcc_builder_create_vector(B, vec, N##_vec_len(vec), S, A, FLATBUFFERS_COUNT_MAX(S))                 \
    );                                                                                                                 \
  }                                                                                                                    \
...
#define __flatbuffers_build_union_vector(NS, N)                                                                        \
  ...
  __flatbuffers_build_union_vector_ops(                                                                                \
      NS, N##_vec, N, N                                                                                                \
  ) /* Preserves DAG structure separately for type and value vector, so a type vector could be shared for many value   \
       vectors. */                                                                                                     \
...
#define __flatbuffers_build_offset_vector(NS, N)                                                                       \
  ...
  __flatbuffers_build_offset_vector_ops(NS, N##_vec, N, N) static inline N##_vec_ref_t N##_vec_clone(                  \
      NS##builder_t *B, N##_vec_t vec                                                                                  \
  ) {                                                                                                                  \
    int _ret;                                                                                                          \
    N##_ref_t _e;                                                                                                      \
    size_t _i, _len;                                                                                                   \
...
#define __flatbuffers_build_string(NS)                                                                                 \
  ...
  __flatbuffers_build_string_ops(NS, NS##string) __flatbuffers_build_offset_vector(NS, NS##string)
...
#define __flatbuffers_build_scalar(NS, N, T)                                                                           \
  __##NS##define_scalar_primitives(NS, N, T) __##NS##define_fixed_array_primitives(NS, N, T)                           \
...
#define __flatbuffers_build_table(NS, N, K)                                                                            \
  ...
  static inline N##_ref_t N##_end(NS##builder_t *B) {                                                                  \
    FLATCC_ASSERT(                                                                                                     \
        flatcc_builder_check_required(B, __##N##_required, sizeof(__##N##_required) / sizeof(__##N##_required[0]) - 1) \
    );                                                                                                                 \
...
#define __flatbuffers_build_table_field(ID, NS, N, TN, TT)                                                             \
  static inline int N##_add(NS##builder_t *B, TN##_ref_t ref) {                                                        \
    TN##_ref_t *_p;                                                                                                    \
    return (ref && (_p = flatcc_builder_table_add_offset(B, ID))) ? ((*_p = ref), 0) : -1;                             \
  }                                                                                                                    \
  static inline int N##_start(NS##builder_t *B) {                                                                      \
    return TN##_start(B);                                                                                              \
  }                                                                                                                    \
...
#define __flatbuffers_build_union_field(ID, NS, N, TN, TT)                                                             \
  ...
  static inline int N##_add_type(NS##builder_t *B, TN##_union_type_t type) {                                           \
    ...
    if (type == TN##_NONE)                                                                                             \
      return 0;                                                                                                        \
    return (_pt = (TN##_union_type_t *)flatcc_builder_table_add(B, ID - 1, sizeof(*_pt), sizeof(*_pt)))                \
               ? ((*_pt = type), 0)                                                                                    \
               : -1;                                                                                                   \
  }                                                                                                                    \
  static inline int N##_add_value(NS##builder_t *B, TN##_union_ref_t uref) {                                           \
    ...
    if (uref.type == TN##_NONE)                                                                                        \
      return 0;                                                                                                        \
    return (p = flatcc_builder_table_add_offset(B, ID)) ? ((*p = uref.value), 0) : -1;                                 \
  }                                                                                                                    \
...
#define __flatbuffers_build_offset_vector_field(ID, NS, N, TN, TT)                                                     \
  ...
  __flatbuffers_build_offset_vector_ops(NS, N, N, TN) static inline int N##_clone(NS##builder_t *B, TN##_vec_t vec) {  \
    return N##_add(B, TN##_vec_clone(B, vec));                                                                         \
  }                                                                                                                    \
  static inline int N##_pick(NS##builder_t *B, TT##_table_t t) {                                                       \
    TN##_vec_t _p = N##_get(t);                                                                                        \
...
#define __flatbuffers_build_string_field(ID, NS, N, TT)                                                                \
  ...
  __flatbuffers_build_string_field_ops(NS, N) static inline int N##_pick(NS##builder_t *B, TT##_table_t t) {           \
    NS##string_t _p = N##_get(t);                                                                                      \
    return _p ? N##_clone(B, _p) : 0;                                                                                  \
  }

#define __flatbuffers_build_table_vector_field(ID, NS, N, TN, TT)                                                      \
  __flatbuffers_build_offset_vector_field(ID, NS, N, TN, TT) __flatbuffers_build_table_vector_ops(NS, N, TN)
...
#define __flatbuffers_build_string_vector_field(ID, NS, N, TT)                                                         \
  __flatbuffers_build_offset_vector_field(ID, NS, N, NS##string, TT) __flatbuffers_build_string_vector_ops(NS, N)
