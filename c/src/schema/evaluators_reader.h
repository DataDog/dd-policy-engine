...
#define dd_wls_CmpTypeNUM_CMP_NUM_UNKNOWN ((dd_wls_CmpTypeNUM_enum_t)INT8_C(0))
#define dd_wls_CmpTypeNUM_CMP_EQ ((dd_wls_CmpTypeNUM_enum_t)INT8_C(1))
#define dd_wls_CmpTypeNUM_CMP_GT ((dd_wls_CmpTypeNUM_enum_t)INT8_C(2))
#define dd_wls_CmpTypeNUM_CMP_GTE ((dd_wls_CmpTypeNUM_enum_t)INT8_C(3))
#define dd_wls_CmpTypeNUM_CMP_LT ((dd_wls_CmpTypeNUM_enum_t)INT8_C(4))
#define dd_wls_CmpTypeNUM_CMP_LTE ((dd_wls_CmpTypeNUM_enum_t)INT8_C(5))
#define dd_wls_CmpTypeNUM_CMP_COUNT ((dd_wls_CmpTypeNUM_enum_t)INT8_C(6))

static inline const char *dd_wls_CmpTypeNUM_name(dd_wls_CmpTypeNUM_enum_t value)
{
    switch (value) {
    case dd_wls_CmpTypeNUM_CMP_NUM_UNKNOWN: return "CMP_NUM_UNKNOWN";
...
{
    switch (value) {
    case dd_wls_CmpTypeNUM_CMP_NUM_UNKNOWN: return 1;
...
/**  An enum representing the type of action to take. */
#define dd_wls_CmpTypeSTR_CMP_STR_UNKNOWN ((dd_wls_CmpTypeSTR_enum_t)INT8_C(0))
#define dd_wls_CmpTypeSTR_CMP_PREFIX ((dd_wls_CmpTypeSTR_enum_t)INT8_C(1))
...
{
    switch (value) {
    case dd_wls_CmpTypeSTR_CMP_STR_UNKNOWN: return "CMP_STR_UNKNOWN";
...
{
    switch (value) {
    case dd_wls_CmpTypeSTR_CMP_STR_UNKNOWN: return 1;
