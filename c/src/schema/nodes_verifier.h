...
static inline int dd_wls_NodeTypeWrapper_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, dd_wls_NodeTypeWrapper_identifier, &dd_wls_NodeTypeWrapper_verify_table);
}
...
static inline int dd_wls_NodeTypeWrapper_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, dd_wls_NodeTypeWrapper_type_identifier, &dd_wls_NodeTypeWrapper_verify_table);
}
...
static inline int dd_wls_NodeTypeWrapper_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &dd_wls_NodeTypeWrapper_verify_table);
}
...
static inline int dd_wls_NodeTypeWrapper_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &dd_wls_NodeTypeWrapper_verify_table);
}
...
static inline int dd_wls_CompositeNode_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, dd_wls_CompositeNode_identifier, &dd_wls_CompositeNode_verify_table);
}
...
static inline int dd_wls_CompositeNode_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, dd_wls_CompositeNode_type_identifier, &dd_wls_CompositeNode_verify_table);
}
...
static inline int dd_wls_CompositeNode_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &dd_wls_CompositeNode_verify_table);
}
...
static inline int dd_wls_CompositeNode_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &dd_wls_CompositeNode_verify_table);
}
...
static inline int dd_wls_EvaluatorNode_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, dd_wls_EvaluatorNode_identifier, &dd_wls_EvaluatorNode_verify_table);
}
...
static inline int dd_wls_EvaluatorNode_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, dd_wls_EvaluatorNode_type_identifier, &dd_wls_EvaluatorNode_verify_table);
}
...
static inline int dd_wls_EvaluatorNode_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &dd_wls_EvaluatorNode_verify_table);
}
...
static inline int dd_wls_EvaluatorNode_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &dd_wls_EvaluatorNode_verify_table);
}
