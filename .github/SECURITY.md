...
This document outlines the security policy for the Datadog Policies Engine and what to do if you discover a security vulnerability in the project.
...
We accept vulnerability submissions for the [currently maintained release](https://github.com/DataDog/dd-policy-engine/releases).
